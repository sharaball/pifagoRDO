...
if ($testType -eq 'standard') {
    ...
    if ($rawTargets.Count -eq 0) {
		...
		Add-OrSet $rawTargets "Roblox"                 "https://roblox.com"
		Add-OrSet $rawTargets "Roblox rblx"            "https://rblx.org"
		Add-OrSet $rawTargets "Roblox rbx"             "https://rbx.com"
		Add-OrSet $rawTargets "Roblox CDN"             "https://rbxcdn.com"
		Add-OrSet $rawTargets "Roblox API"             "https://roblox-api.arkoselabs.co"
		Add-OrSet $rawTargets "Roblox Labs"            "https://robloxlabs.com"
		Add-OrSet $rawTargets "Roblox Cloudfront"      "https://d1unuk07s6td74.cloudfront.net"
		Add-OrSet $rawTargets "Roblox Load Gen"        "https://roblox-load-generator-configuration.s3.us-east-2.amazonaws.com"
		Add-OrSet $rawTargets "Roblox Fastly"          "https://roblox-poc.global.ssl.fastly.net"
		Add-OrSet $rawTargets "Roblox corp"    	       "https://robloxcorp.s.llnwi.net"
		Add-OrSet $rawTargets "Create Roblox"    	   "https://create.roblox.com/"
...
Write-Host "                 pifagoRDO CONFIG TESTS" -ForegroundColor Cyan
